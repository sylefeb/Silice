...
yosys -p "read_verilog -sv build.v" -p "synth_ice40 -relut -dsp -json build.json -abc9 -device u -top top"
nextpnr-ice40 --up5k --freq 12 --package sg48 --json build.json --pcf $BOARD_DIR/musbx.pcf --asc build.asc -r
