...
NEXTPNR_CMD=$(command -v nextpnr-himbaechel || command -v nextpnr-himbaechel-gowin)
...
"$NEXTPNR_CMD" --json build.json --write outbuild.json --device GW2AR-LV18QN88C8/I7 --vopt family=GW2A-18C --vopt cst=$BOARD_DIR/tang_nano_20k.cst
