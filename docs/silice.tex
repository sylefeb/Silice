...
\silice{} makes it possible to write algorithms for FPGAs in the same way we write them for processors: by defining sequences of operations, subroutines you can call, and using loop statements such as \texttt{while} (even good old \texttt{goto}s are available!). 
