...
if [ -z "$2" ]; then 
  echo "Adding mylibc"
  $ARCH-elf-gcc -w -O3 -fno-pic -fno-builtin -march=$riscarch -mabi=ilp32 -c -DBLAZE -DMYLIBC_SMALL smoke/mylibc/mylibc.c -o build/mylibc.o
...
$ARCH-elf-gcc -O3 -fno-pic -fno-builtin -march=$riscarch -mabi=ilp32 -DBLAZE  -S $1 -o build/code.s
