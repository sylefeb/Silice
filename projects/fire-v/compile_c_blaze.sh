...
if [ -z "$2" ]; then
  echo "Adding mylibc"
  $ARCH-gcc -w -O3 -ffunction-sections -fdata-sections -fno-stack-protector -fno-pic -fno-builtin -march=$riscarch -mabi=ilp32 -c -DBLAZE smoke/mylibc/mylibc.c -o build/mylibc.o
