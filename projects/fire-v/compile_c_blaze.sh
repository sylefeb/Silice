...
if [ -z "$2" ]; then 
  echo "Adding mylibc"
  $ARCH-elf-gcc -w -O3 -ffunction-sections -fdata-sections -fno-pic -fno-builtin -march=$riscarch -mabi=ilp32 -c -DBLAZE smoke/mylibc/mylibc.c -o build/mylibc.o
...
$ARCH-elf-gcc -O3 -ffunction-sections -fdata-sections -fno-pic -fno-builtin -fverbose-asm -march=$riscarch -mabi=ilp32 -DBLAZE -S $1 -o build/code.s
$ARCH-elf-gcc -O3 -ffunction-sections -fdata-sections -fno-pic -fno-builtin -march=$riscarch -mabi=ilp32 -DBLAZE -c -o build/code.o $1
...
$ARCH-elf-ld --gc-sections -m elf32lriscv -b elf32-littleriscv -Tsmoke/config_blaze.ld --no-relax -o build/code.elf $OBJECTS
