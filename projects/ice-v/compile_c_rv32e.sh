...
$ARCH-elf-gcc -fstack-reuse=none -fno-builtin -fno-unroll-loops -O1 -fno-pic -march=rv32e -mabi=ilp32e -S $1 -o build/code.s
$ARCH-elf-gcc -fstack-reuse=none -fno-builtin -fno-unroll-loops -O1 -fno-pic -march=rv32e -mabi=ilp32e -c -o build/code.o $1

$ARCH-elf-as -march=rv32e -mabi=ilp32e -o crt0.o crt0.s
