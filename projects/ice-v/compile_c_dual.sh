...
$ARCH-elf-as -march=rv32i -mabi=ilp32 -o crt0.o crt0_dual.s

$ARCH-elf-ld -m elf32lriscv -b elf32-littleriscv -Tconfig_c_dual.ld --no-relax -o build/code.elf build/code.o
