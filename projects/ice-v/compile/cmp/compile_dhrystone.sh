...
$ARCH-gcc -std=gnu99 -w -fstack-reuse=none -fno-builtin -O3 -Wno-implicit-function-declaration -Wno-implicit-int -fno-stack-protector -fno-pic -march=rv32i -mabi=ilp32 -T$BASE/config_c.ld -ffreestanding -nostdlib -o $DST/code.elf $BASE/crt0.s ../fire-v/smoke/mylibc/div.s $BASE/mylibc.c $MAIN
