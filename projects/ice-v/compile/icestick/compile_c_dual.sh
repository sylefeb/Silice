...
$ARCH-elf-as -march=rv32i -mabi=ilp32 -o crt0.o compile/icestick/crt0_dual.s

$ARCH-elf-ld -m elf32lriscv -b elf32-littleriscv -Tcompile/icestick/config_c_dual.ld --no-relax -o compile/build/code.elf compile/build/code.o
