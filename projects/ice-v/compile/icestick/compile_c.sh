...
$ARCH-elf-gcc -DICESTICK -fno-builtin -fno-unroll-loops -O1 -fno-pic -march=rv32i -mabi=ilp32 -S $1 -o compile/build/code.s
$ARCH-elf-gcc -DICESTICK -fno-builtin -fno-unroll-loops -O1 -fno-pic -march=rv32i -mabi=ilp32 -c -o compile/build/code.o $1
