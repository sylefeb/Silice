...
BASE=./compile/icestick/dual
DST=./compile/build

$ARCH-gcc -DICESTICK -O$OPT_LEVEL -fstack-reuse=none -fno-builtin -fno-unroll-loops -fno-stack-protector -fno-pic -march=rv32i -mabi=ilp32 -fverbose-asm -S $1 -o $DST/code.s
$ARCH-gcc -DICESTICK -O$OPT_LEVEL -fstack-reuse=none -fno-builtin -fno-unroll-loops -fno-stack-protector -fno-pic -march=rv32i -mabi=ilp32 -c -o $DST/code.o $1
