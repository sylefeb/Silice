...
$ARCH-gcc -DICESTICK -fstack-reuse=none -fno-builtin -fno-unroll-loops -O1 -fno-pic -march=rv32e -mabi=ilp32e -S $1 -o compile/build/code.s
$ARCH-gcc -DICESTICK -fstack-reuse=none -fno-builtin -fno-unroll-loops -O1 -fno-pic -march=rv32e -mabi=ilp32e -c -o compile/build/code.o $1
