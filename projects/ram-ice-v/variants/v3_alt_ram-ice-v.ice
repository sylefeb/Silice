...
$$end
  ...
  int32 cmpA        = uninitialized;
  int32 cmpB        = uninitialized;
...
$$end
        ...
        switch (loadStoreOp) {
          case 3b000: { // SB
              switch (alu_out[0,2]) {
                case 2b00: { ram.data_in[ 0,8] = cmpB[ 0,8]; ram.wmask = 4b0001; }
                case 2b01: { ram.data_in[ 8,8] = cmpB[ 0,8]; ram.wmask = 4b0010; }
                case 2b10: { ram.data_in[16,8] = cmpB[ 0,8]; ram.wmask = 4b0100; }
                case 2b11: { ram.data_in[24,8] = cmpB[ 0,8]; ram.wmask = 4b1000; }
              }
          }
          case 3b001: { // SH
              switch (alu_out[1,1]) {
                case 1b0: { ram.data_in[ 0,16] = cmpB[ 0,16]; ram.wmask = 4b0011; }
                case 1b1: { ram.data_in[16,16] = cmpB[ 0,16]; ram.wmask = 4b1100; }
              }
          }
          case 3b010: { // SW
            ram.data_in = cmpB; ram.wmask = 4b1111;
          }
